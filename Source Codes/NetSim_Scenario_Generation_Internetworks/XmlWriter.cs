...
{ 
    public class XmlWriter
    {
        ...
        */
        public XmlNode open_document(string header_location)
        {
            outputDoc = new XmlDocument();
            XmlNode rootNode = outputDoc.CreateXmlDeclaration("1.0", "UTF-8", "no");
            ...
            //XmlAttribute attrib = outputDoc.CreateAttribute("ns0:" + "noNamespaceSchemaLocation");
            //attrib.Value = "Configuration.xsd";
            //rootNode.Attributes.Append(attrib);

            string raw_xml = "<TETCOS_NETSIM> </TETCOS_NETSIM>";
                //" xmlns:ns0=\"http://www.w3.org/2001/XMLSchema-instance\" ns0:noNamespaceSchemaLocation=\"Configuration.xsd\">";

            //String content = File.ReadAllText(header_location);
            /*XmlDocument doc = new XmlDocument();
            doc.LoadXml(content);
            XmlNode newNode = doc.DocumentElement;
            XmlNode importNode = outputDoc.ImportNode(newNode, true);
            parent.AppendChild(importNode);*/
            Console.WriteLine(raw_xml);
            XmlDocument doc = new XmlDocument();
            doc.LoadXml(raw_xml);
          /*  XmlNode abcNode = doc.DocumentElement;
            outputDoc.AppendChild(abcNode);*/
        ...
        public XmlNode add_experimentInfo(XmlNode parent, string exp_name, string version_name)
        {
            ...
            verNumElement.InnerText = "13.0.22";
            ...
            commentElement.InnerText = "Internetwork Test Case";
        ...
        */
        ...
        /*
          ...
          params: parent-node to which the child has be appended
                  ...
                  args- parameters for formatting the txt file
